...
public sealed partial class CloudShadows : Node {
    ...
    public void Build(Texture2D weather, Texture3D shape, Texture3D detail, float radius, float cloudBase, float cloudTop, Vector3 coastalWeather) {
        ...
        _material = new ShaderMaterial { Shader = GD.Load<Shader>("res://Shaders/CloudShadow.gdshader") };
        ...
        ShaderMaterial filter = new() { Shader = GD.Load<Shader>("res://Shaders/CloudShadowFilter.gdshader") };
        ...
        _lightingMaterial.Shader = GD.Load<Shader>("res://Shaders/CloudLighting.gdshader");
