...
Ground strikes trace against the simulation's terrain survey and sea-level water surface. A local terrain normal orients the clipped wall jet. Land produces brown dust and water produces pale steam. Emission builds over 0.6 seconds; billows are emitted at randomized 0.26–0.38 second intervals, fade in over 0.3 seconds, spread outward and rise, then disperse over a 10-second lifetime. Each billow retains its body-fixed birthplace after the engine moves or stops. Growth reduces density by the inverse volume ratio; dust is flatter and rises more slowly than steam. Every billow is clipped against its birth surface plane. The renderer tracks up to 40 billows per engine inside one bounded volume. Water retains depression, ripples and foam; the strongest current water strike drives that surface deformation while all emitters retain independent steam volumes. Cloud clearings remain bounded to eight capsules.
